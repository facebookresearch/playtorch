...
<div className="tutorial-oneliner">In this tutorial, we will connect our PyTorch Live demo to the server we created in [the GPT server model tutorial](/docs/tutorials/server-model).</div>

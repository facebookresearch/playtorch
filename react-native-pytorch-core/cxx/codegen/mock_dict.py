...
ops_decl = [
    ...
    },
    {
        "name": "div",
        "operator_name": "div",
        "overload_name": "Scalar_mode",
        "manual_kernel_registration": False,
        "category_override": "",
        "schema_string": "aten::div.Scalar_mode(Tensor self, Scalar other, *, str? rounding_mode) -> Tensor",
        "arguments": [
            {
                "annotation": None,
                "dynamic_type": "at::Tensor",
            ...
            {
                "annotation": None,
                "dynamic_type": "c10::string_view",
                "is_nullable": True,
                "kwarg_only": True,
                "name": "rounding_mode",
                "type": "c10::optional<c10::string_view>",
            },
        ],
        "schema_order_cpp_signature": "at::Tensor (const at::Tensor &, const at::Scalar &, c10::optional<c10::string_view>)",
        "schema_order_arguments": [
            {
                "annotation": None,
                "dynamic_type": "at::Tensor",

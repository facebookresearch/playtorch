...
You can find the [completed versions of the source code](https://github.com/pytorch/live/tree/main/examples/gpt3-server-tutorials/ptl-server) we've written in this tutorial in the `examples` folder PlayTorch GitHub repo.

...
import BrewIssues from '@site/docs/tutorials/fb/_brew-issues.mdx';
import WhereToRun from '@site/docs/tutorials/fb/_where-to-run.mdx';
import ChangedNPMRegistry from '@site/docs/tutorials/fb/_changed-npm-registry.mdx';
...
- **Our beta release only supports MacOS**. Windows and Linux supports are coming soon.

...
| `startRecord` | () => `void` |
| `stopRecord` | () => `Promise`<[Audio](../interfaces/audio_audiomodule.audio.md)\> |
| `toFile` | (`audio`: [Audio](../interfaces/audio_audiomodule.audio.md)) => `Promise`<string\> |

#### Defined in

[audio/AudioModule.ts:31](https://github.com/pytorch/live/blob/8c557f0/react-native-pytorch-core/src/audio/AudioModule.ts#L31)
...
[audio/AudioModule.ts:24](https://github.com/pytorch/live/blob/8c557f0/react-native-pytorch-core/src/audio/AudioModule.ts#L24)
